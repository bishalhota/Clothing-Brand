...
//Async thunk that will fetch all products from the backend based on filters
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchProductsByFilters.rejected, (state, action) => {
                state.loading = false;
                state.error = action.error.messDetails
            })
